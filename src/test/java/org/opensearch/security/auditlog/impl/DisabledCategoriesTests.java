...
public class DisabledCategoriesTests {
	...
	public void invalidRestCategoryConfigurationTest() {
		...
		AuditTestUtils.createAuditLog(settingsBuilder.build(), null, null, AbstractSecurityUnitTests.MOCK_POOL, null, cs);
	}
	...
	public void invalidConfigurationTest() {
		...
		AbstractAuditLog auditLog = AuditTestUtils.createAuditLog(settingsBuilder.build(), null, null, AbstractSecurityUnitTests.MOCK_POOL, null, cs);
		logAll(auditLog);
