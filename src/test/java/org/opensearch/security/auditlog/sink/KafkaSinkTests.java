...
import org.opensearch.security.auditlog.AbstractAuditlogiUnitTests;

public class KafkaSinkTests extends AbstractAuditlogiUnitTests {

	@ClassRule
	public static EmbeddedKafkaRule embeddedKafka = new EmbeddedKafkaRule(1, true, 1, "compliance");

	@Test
	//fixme does it fail because of missing dependency?
