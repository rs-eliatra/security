...
public class AuditlogTests {
    ...
    public void testClusterHealthRequest() {
        Settings settings = Settings.builder()
                ...
                .build();
        AbstractAuditLog al = AuditTestUtils.createAuditLog(settings, null, null, AbstractSecurityUnitTests.MOCK_POOL, null, cs);
    ...
    public void testRestFilterEnabledCheck() {
        final Settings settings = Settings.builder()
                ...
                .build();
        final AbstractAuditLog al = AuditTestUtils.createAuditLog(settings, null,  null, AbstractSecurityUnitTests.MOCK_POOL, null, cs);
